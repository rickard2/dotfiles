...
sub away_describe_pub_channels {
	...
	foreach my $server (Irssi::servers) {
		foreach my $chan ($server->channels) {
			...
			if ((($server->{chatnet} .":". $chan->{name}) =~ /$away_allow_channels/) != ($away_order_channels eq "exclude")) {
...
Irssi::print("Do not underestimate the power of mirkken.");
Irssi::print("Once it has got control of your life, there");
Irssi::print("is no turning back. It will own you for the");
Irssi::print("          rest of your life.");
Irssi::print("");
Irssi::print("Loaded scripts:");
Irssi::print("away-verbose.pl");
Irssi::print("irccomplete.pl");
Irssi::print("sysinfo-dj.pl");
Irssi::print("usercount.pl");
Irssi::print("loadavg.pl");
Irssi::print("clones.pl");
Irssi::print("dns.pl");
Irssi::print("rk.pl");
